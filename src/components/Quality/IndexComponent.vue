  ...
  <b-container fluid>
    ...
    <b-row>
      ...
      <b-col md="6" class="text-right">
        <b-button class="btn btn-primary" @click="CreateQuality()">Create Quality</b-button>
      </b-col>
    </b-row>
    ...
    >
      ...
      <template slot="edit" slot-scope="row">
        <router-link :to="{name: 'quality/edit', params: { id: row.item.id }}">
...
export default {
  ...
  methods: {
    ...
    CreateQuality() {
      this.$router.push({ name: "quality/create" });
    },
    ...
    Delete(id) {
      this.toggleBusy();
      QualityService.delete(id).then(response => {
        this.getQualities();
      });
    },
    SetIdForDelete(id) {
