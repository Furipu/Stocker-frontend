  ...
  <b-container fluid>
    ...
    <b-row>
      ...
      <b-col md="6" class="text-right">
        <b-button class="btn btn-primary" @click="CreateMetric()">Create Metric</b-button>
      </b-col>
    </b-row>
    ...
    >
      ...
      <template slot="edit" slot-scope="row">
        <router-link :to="{name: 'metric/edit', params: { id: row.item.id }}">
...
export default {
  ...
  methods: {
    ...
    CreateMetric() {
      this.$router.push({ name: "metric/create" });
    },
    ...
    Delete(id) {
      this.toggleBusy();
      MetricService.delete(id).then(response => {
        this.getMetrics();
      });
    },
    SetIdForDelete(id) {
